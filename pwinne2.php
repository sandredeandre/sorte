...
require_once("conn/conn.php");
		...
		$result = "SELECT * FROM sorteio  WHERE premio = 10000000";
		$resultado = mysqli_query($conn, $result);
		$resulta = mysqli_fetch_assoc($resultado);
		
if(!empty($resulta )){
	
	$result = "SELECT id_user, date, ideve, eve, key1  FROM sorteio  WHERE premio = 10000000 BETWEEN 1 and 70000 LIMIT 1";
